...
public class MessageStatusRecogListener extends StatusRecogListener {
    ...
    public void onAsrReady() {
        ...
        Log.d(TAG, "onAsrReady: 引擎就绪，可以开始说话。");
    }
    ...
    public void onAsrEnd() {
        ...
        Log.d(TAG, "onAsrEnd: 【asr.end事件】检测到用户说话结束");
    }
    ...
    public void onAsrPartialResult(String[] results, RecogResult recogResult) {
        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_PARTIAL,
                "" + results[0] + "" );
        Log.d(TAG, "onAsrPartialResult: 臨時識別結果：" + results[0]);
    ...
    public void onAsrFinalResult(String[] results, RecogResult recogResult) {
        ...
        Log.d(TAG, "onAsrFinalResult: " + message);
        speechEndTime = 0;
        sendMessage(res, status, true);
    }
    ...
    public void onAsrFinishError(int errorCode, int subErrorCode, String descMessage,
        ...
        Log.d(TAG, "onAsrFinishError: " + message);
        speechEndTime = 0;
        sendMessage("發生錯誤了", status, true);
        speechEndTime = 0;
    }
    ...
    public void onAsrFinish(RecogResult recogResult) {
        ...
        Log.d(TAG, "onAsrFinish: 识别一段话结束。如果是长语音的情况会继续识别下段话。");
    ...
    public void onAsrLongFinish() {
        ...
        Log.d(TAG, "onAsrLongFinish: 长语音识别结束。");
    }
    ...
    public void onOfflineUnLoaded() {
        ...
        Log.d(TAG, "onOfflineUnLoaded: 离线资源卸载成功。");
    }
    ...
    public void onAsrExit() {
        ...
        Log.d(TAG, "onAsrExit: 识别引擎结束并空闲中");
    }
