...
import com.mengyuan1998.finger_dancing.my_view.CameraPreview;
...
public class PublishActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture,
            ...
            openCamera(1080, 1440);
            Log.d(TAG, "onSurfaceTextureAvailable: listener width: " + width + " height: " + height);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextureView = (CameraPreview) findViewById(R.id.texture);
        mButtonVideo = (Button) findViewById(R.id.video);
        mButtonVideo.setOnClickListener(this);
    }

    /**
     * In this sample, we choose a video size with 4x3 aspect ratio. Also, we don't use sizes
    ...
    private static Size chooseOptimalSize(Size[] choices, int width, int height, Size aspectRatio) {
        ...
        for (Size option : choices) {
            Log.d(TAG, "chooseOptimalSize: size: width " + option.getWidth() + " height " + option.getHeight());
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            ...
            Log.d(TAG, "onResume: ava width: " + mTextureView.getWidth() + " height: " + mTextureView.getHeight() );
        } else {
    ...
    /*private void requestVideoPermissions() {
        if (shouldShowRequestPermissionRationale(VIDEO_PERMISSIONS)) {
            showRationaleDialog("不知道是什么", VIDEO_PERMISSIONS, REQUEST_VIDEO_PERMISSIONS);
        } else {
                ...
                for (int result : grantResults) {
                    if (result != PackageManager.PERMISSION_GRANTED) {
                       *//* ErrorDialog.newInstance(getString(R.string.permission_request))
                        ...
                        Log.d(TAG, "onRequestPermissionsResult: deniey");
                        break;
                    }
                }
            } else {
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                ...
                Log.d(TAG, "openCamera: set ");
            } else {
                mTextureView.setAspectRatio(mPreviewSize.getHeight(), mPreviewSize.getWidth());
                Log.d(TAG, "openCamera: set t");
            }
            configureTransform(width, height);
    ...
    private void startPreview() {
        ...
        try {
            ...
            assert texture != null;
            texture.setDefaultBufferSize(1080, 1080);
