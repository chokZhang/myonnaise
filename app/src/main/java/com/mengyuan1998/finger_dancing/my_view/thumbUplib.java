package com.mengyuan1998.finger_dancing.my_view;
...
public class thumbUplib extends View {
    ...
    public thumbUplib(Context context) {
        this(context, null);
    }

    public thumbUplib(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public thumbUplib(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.thumbUplib);
        if (typedArray != null) {
            edgeColor = typedArray.getColor(R.styleable.thumbUplib_edgeColor, edgeColor);
            fillColor = typedArray.getColor(R.styleable.thumbUplib_fillColor, fillColor);
            cracksColor = typedArray.getColor(R.styleable.thumbUplib_cracksColor, cracksColor);
            bgColor = typedArray.getColor(R.styleable.thumbUplib_bgColor, bgColor);

            int type = typedArray.getInteger(R.styleable.thumbUplib_unlikeType, 0);
